...
<div class="container">
    ...
    <form action="includes/adminUpdateParcel-inc.php" method="POST">
        <div class="input-group mb-3">
            <input type="hidden" name="parcel_id" placeholder="Parcel ID" value="<?php echo $_POST['parcelID']; ?>" minlength="1">
            ...
            <input type="text" name="parcel_status" placeholder="Status" value="<?php echo $_POST['parcel_status']; ?>" maxlength="18">
    ...
    <table class="table-sm table-hover table-responsive">
        ...
        switch ($errorMessage) 
        {
            ...
            case "invalidTrackFormat";
                ...
                break;
            case "parcelUpdate":
                echo "<p style='color: green;'>Parcel info successfully updated</p>";
                break;
        }
        ?>
    </table>
